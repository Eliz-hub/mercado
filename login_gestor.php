...
<body class="text-center" style="background-color: antiquewhite;">
  ...
  <main class="form-signin w-100 m-auto" style="background-color: white;">
    <form action="" method="POST" class="form-signin">
      <img class="mb-4" src="icon/gestor.png" alt="" width="50" height="50">
      ...
      <?php
        if (isset($_POST['numero']) || isset($_POST['senha'])) {
          ...
          if (strlen($_POST['numero']) == 0) {
            ...
            $sql_code = "SELECT * FROM gestor WHERE cell = '$numero' AND pass = '$pass_crypt'";
            ...
            if ($quantidade == 1) {
              ...
              $_SESSION['cell'] = $caixa['cell'];

              header("Location: manager/homepage_gestor.php");
            } else {
