...
<head>
    ...
    <title>Novo Registro - Admin</title>
        ...
        <div class="text-center" style="width: 93%; height: 100vh;">
            <div class="row mb-4 text-center" style="margin: 30px 0 0 40px;">
                <div class="col-1" style="background-color: rgba(1,1,1,0.15); margin:8px; min-width: 100px">
                    <a href="registro_gestor.php" class="text-decoration-none" style="color: black; font-size:14px">
                        <img src="../icon/gestor.png" style="width: 63px; height: 69px; margin: 5px;"><br>
                        Gestor
                    </a>
                </div>
                <div class="col-1" style="background-color: rgba(1,1,1,0.15); margin:8px; min-width: 100px">
                    <a href="registro_caixa.php" class="text-decoration-none" style="color: black; font-size:14px">
                        <img src="../icon/caixa.png" style="width: 70px; height: 70px; margin: 5px;"><br>
                        Caixa
                    </a>
                </div>
                <div class="col-1" style="background-color: rgba(1,1,1,0.15); margin:8px; min-width: 100px">
                    <a href="registro_produto.php" class="text-decoration-none" style="color: black; font-size:14px">
                        <img src="../icon/produtos.png" style="width: 63px; height: 69px; margin: 5px;"><br>
                        Produtos
                    </a>
                </div>
            </div>
