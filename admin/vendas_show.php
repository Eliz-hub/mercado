...
if (!empty($_GET['search'])) {
    $data = $_GET['search'];
    $sql = "SELECT * FROM venda WHERE cod_venda LIKE '$data' or cod_produto LIKE '$data' or quantidade LIKE '$data' or data_venda LIKE '$data%' or id_cliente LIKE '$data' ORDER BY cod_venda DESC";
}else{
