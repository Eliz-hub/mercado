...
<head>
    ...
    <title>Registar Caixa - Admin</title>
    ...
    <main class="d-flex flex-nowrap">
        ...
        <div style="width: 93%; height: 100%; min-height: 100vh;">
            <div class="text-center mb-3" style="margin: 30px 0 0 15px;">
                <h3 class="font-weight-normal">Registo de Novo Caixa</h3> <br>
            </div>
            <div class="row">
                <div class="col-md-7" style="margin: 30px 0 0 30px;">
                    <form action="processo_registro_caixa.php" method="POST" class="needs-validation" novalidate="">
                        <div class="col-md-9">
