...
if (!empty($_GET['id_gestor'])) {
    ...
    if ($result->num_rows > 0) {
        while ($gestor_data = mysqli_fetch_assoc($result)) {
            $nome = $gestor_data['nome_completo'];
            $data_nascimento = $gestor_data['data_nascimento'];
            $bi = $gestor_data['numero_bi'];
            $cidade = $gestor_data['cidade'];
            $endereco = $gestor_data['endereco'];
            $cell = $gestor_data['cell'];
            $cell_emerg = $gestor_data['cell_emergencia'];
...
<head>
    ...
    <title>Editar Gestor - Gestor</title>
    ...
    <main class="d-flex flex-nowrap">
        ...
        <div style="width: 93%; height: 100%; min-height: 100vh;">
            <div class="text-center mb-3" style="margin: 30px 0 0 15px;">
                <h3 class="font-weight-normal">Editar Gestor</h3> <br>
            </div>
            <div class="row">
                <div class="col-md-7" style="margin: 30px 0 0 30px;">
                    <form action="save_edit_gestor.php" method="POST" class="needs-validation" novalidate="">
                        <div class="col-md-9">
