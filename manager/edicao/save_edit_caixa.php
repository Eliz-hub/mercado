...
include ('protect.php');
    ...
    if (isset($_POST['update'])) {
        ...
        $sqlUpdate = "UPDATE caixa SET nome_completo='$nome',data_nascimento='$data_nascimento',nr_bi='$nr_bi',cidade='$cidade',endereco='$endereco',cell='$cell',cell_emergencia='$cell_emerg', email='$email' WHERE id_caixa='$id'";
