...
<head>
    ...
    <title>Editar Estoque - Gestor</title>
            ...
            <div class="col-md-12" style="margin: 30px 0 0 30px;">
                <form action="save_edit_stock.php" method="POST" class="needs-validation" novalidate="">
                    ...
                    <div class="col-md-12 text-center">
                        <button class="btn btn-lg btn-primary btn-block" type="submit" name="update" id="update" style="margin-bottom: 2px;">Registar</button>
                    </div>
                    <br>
                    <br>
                </form>
