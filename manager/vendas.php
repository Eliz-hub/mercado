...
<!---------------------------------------------------------------------------------------------------------------------------------->
        ...
        <div class="text-center" style="width: 93%; height: 100vh;">
            <div class="row mb-4 text-center" style="margin: 30px 0 0 40px;">
                <div class="col-1" style="background-color: rgba(1,1,1,0.15); margin:10px; min-width: 100px">
                    <a href="venda0.php" class="text-decoration-none" style="color: black; font-size:13px">
                        <img src="../icon/add.png" style="width: 69px; height: 69px; margin: 5px;"><br>
                        Adicionar
                    </a>
                </div>
                <div class="col-1" style="background-color: rgba(1,1,1,0.15); margin:10px; min-width: 100px">
                    <a href="vendas_show.php" class="text-decoration-none" style="color: black; font-size:13px">
                        <img src="../icon/venda.png" style="width: 70px; height: 70px; margin: 5px;"><br>
                        Vendas
                    </a>
                </div>
            </div>
