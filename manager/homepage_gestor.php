...
<head>
    ...
    <title>Pagina Inicial - Gestor</title>
...
<!---------------------------------------------------------------------------------------------------------------------------------->
        ...
        <div class="text-center" style="width: 100vw; height: 100vh;">
            <h2 style="margin-top: 15%;">Bem-vindo ao Painel de Gestor</h2><br><br>
            <p style="font-size: 90%"> O painel de Gestor permite fazer todas as operações possíveis para a gestão no Software.</p>
            <br>
            <h6>Permissões:</h6>
